...
if __name__ == '__main__':
    ...
    record_type = RecordType.from_type_schema( "",schema_decoder,{})
    while True:
        ...
        if BLACKBOX_MULTIROW_INFER:
            ...
            try:
                ...
                logger.info(f"done with updating loop")
                ...
                logger.info(f"finished updating loop")
                _ = h_tbl_out_audit.insert_records(results_package_list)
                logger.info(f"finished persisting audit table")
